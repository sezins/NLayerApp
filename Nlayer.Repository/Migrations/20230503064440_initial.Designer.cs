...
namespace Nlayer.Repository.Migrations
{
    ...
    [Migration("20230503064440_initial")]
            ...
            modelBuilder.Entity("Nlayer.Core.Entity.Product", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CategoryId = 1,
                            CreatedDate = new DateTime(2023, 5, 3, 9, 44, 39, 765, DateTimeKind.Local).AddTicks(1798),
                            Name = "Kalem 1",
                            Price = 100m,
                            Stock = 20
                        },
                        new
                        {
                            Id = 2,
                            CategoryId = 2,
                            CreatedDate = new DateTime(2023, 5, 3, 9, 44, 39, 765, DateTimeKind.Local).AddTicks(1809),
                            Name = "Kitap 1",
                            Price = 100m,
                            Stock = 20
                        },
                        new
                        {
                            Id = 3,
                            CategoryId = 3,
                            CreatedDate = new DateTime(2023, 5, 3, 9, 44, 39, 765, DateTimeKind.Local).AddTicks(1810),
                            Name = "Kalem 1",
                            Price = 100m,
                            Stock = 20
                        });
