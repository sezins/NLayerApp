    ...
    public partial class initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, 1, new DateTime(2023, 5, 3, 9, 44, 39, 765, DateTimeKind.Local).AddTicks(1798), "Kalem 1", 100m, 20, null });

            migrationBuilder.InsertData(
                table: "Products",
                columns: new[] { "Id", "CategoryId", "CreatedDate", "Name", "Price", "Stock", "UpdatedDate" },
                values: new object[] { 2, 2, new DateTime(2023, 5, 3, 9, 44, 39, 765, DateTimeKind.Local).AddTicks(1809), "Kitap 1", 100m, 20, null });

            migrationBuilder.InsertData(
                table: "Products",
                columns: new[] { "Id", "CategoryId", "CreatedDate", "Name", "Price", "Stock", "UpdatedDate" },
                values: new object[] { 3, 3, new DateTime(2023, 5, 3, 9, 44, 39, 765, DateTimeKind.Local).AddTicks(1810), "Kalem 1", 100m, 20, null });
